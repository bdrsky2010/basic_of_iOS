...
/*
 ...
 이것은 데이터와 사용자 인터페이스(UI) 내의 뷰 사이에 게시자(Publisher)와
 구독자(Subscrider)를 구축할 수 있다.
 
 > UI의 모양과 동작을 결정하는 [상태 프로퍼티, Observable 객체, State 객체,
 Environment 객체] 를 제공한다.
 */
...
/*
 ...
 - .environmentObject 수정자를 사용해서 뷰 계층 구조에 인스턴스를 추가
 */
