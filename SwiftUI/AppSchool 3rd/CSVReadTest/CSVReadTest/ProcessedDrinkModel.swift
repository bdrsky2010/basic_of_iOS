...
//		case country, description, score, aroma, appearance, flavor, mouthfeel, type
		case country, description, type
	}
}

struct ProcessedCocktail: Codable {
...
struct ProcessedTraditionalLiquor: Codable {
...
struct ProcessedWhisky: Codable {
...
//		case cluster, body, sweet, sherry, malt, aperitif, smoky, pungent, fruity, honey, floral, spicy, medicinal, nutty, winey, images, links
		case cluster, body, sweet, sherry, malt, aperitif, smoky, pungent, fruity, honey, floral, spicy, medicinal, nutty, winey
	}
}

struct ProcessedWine: Codable {
